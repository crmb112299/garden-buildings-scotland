...
const FAQS: FAQItem[] = [
  ...
  },
  {
    ...
    a: "Typical lead times are 2 to 4 weeks from order to install. We'll give you an exact slot when we confirm your order."
  },
  {
  ...
  },
  {
    ...
    a: "Most garden buildings fall under permitted development, so no planning is required. We'll flag it if your project might need a planning application, and point you in the right direction."
  },
  {
